      ...
      <div className="flex-1 text-center md:text-left min-w-0">
        ...
        <div className="flex items-center justify-center md:justify-start gap-3">
          <div className="relative w-10 h-10 md:w-12 md:h-12 flex-shrink-0">
            ...
            />
            <div className="fallback-avatar hidden w-full h-full rounded-full bg-gradient-to-br from-purple-600 to-blue-600 flex items-center justify-center text-white font-bold text-base md:text-lg shadow-lg border border-white/20">
              {authorInitial}
            </div>
